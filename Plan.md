...
- Поле "Номер карты": Неверный формат
- Поле "Месяц": Неверный формат
- Поле "Год": Неверный формат
- Поле "Владелец": Поле обязательно для заполнения
- Поле "CVC/CVV": Неверный формат
...
2.1.2 Отправка невалидных значений в Поле "Номер карты"
    ...
    2.1.2.3 Ввести значение используя спецсимволы (@#%$*&^). Все остальные поля заполнить валидными значениями. Нажать "Продолжить". Ожидаемый результат - форма не позволяет вести спецсимволы.
    2.1.2.4 Ввести значение используя буквы. Все остальные поля заполнить валидными значениями. Нажать "Продолжить". Ожидаемый результат - форма не позволяет вести буквенные значения.
...
2.1.3 Отправка невалидных значений в Поле "Месяц"
    ...
    2.1.3.4 Ввести значение используя спецсимволы (@#%$*&^). Все остальные поля заполнить валидными значениями. Нажать "Продолжить". Ожидаемый результат - форма не позволяет вести спецсимволы.
    2.1.3.5 Ввести значение используя буквы. Все остальные поля заполнить валидными значениями. Нажать "Продолжить". Ожидаемый результат - форма не позволяет вести буквенные значения.
...
2.1.4 Отправка невалидных значений в Поле "Год"
    ...
    2.1.4.5 Ввести значение используя спецсимволы (@#%$*&^). Все остальные поля заполнить валидными значениями. Нажать "Продолжить". Ожидаемый результат - форма не позволяет вести спецсимволы.
    2.1.4.6 Ввести значение используя буквы. Все остальные поля заполнить валидными значениями. Нажать "Продолжить". Ожидаемый результат - форма не позволяет вести буквенные значения.
...
2.1.5 Отправка невалидных значений в Поле "Владелец"
    ...
    2.1.5.2 Ввести значение используя спецсимволы (@#%$*&^). Все остальные поля заполнить валидными значениями. Нажать "Продолжить". Ожидаемый результат - форма не позволяет вести спецсимволы.
    2.1.5.3 Ввести значение используя цифры. Все остальные поля заполнить валидными значениями. Нажать "Продолжить". Ожидаемый результат - форма не позволяет вести буквенные значения.
...
2.1.6 Отправка невалидных значений в Поле "CVC/CVV"
    ...
    2.1.6.3 Ввести значение используя спецсимволы (@#%$*&^). Все остальные поля заполнить валидными значениями. Нажать "Продолжить". Ожидаемый результат - форма не позволяет вести спецсимволы.
    2.1.6.4 Ввести значение используя буквы. Все остальные поля заполнить валидными значениями. Нажать "Продолжить". Ожидаемый результат - форма не позволяет вести буквенные значения.
